...
alter table "public"."admins" enable row level security;
  ...
  create table "public"."clients" (
    ...
    "opened_by" text not null default 'self'::text,
    "wallet_details" jsonb not null default '{}'::jsonb,
    "id_num_og" text not null default '0'::text,
    "cross_commision" double precision not null default '0.01'::double precision
      );
...
alter table "public"."pf-reqs" enable row level security;


  create table "public"."pfs" (
    "id" bigint generated by default as identity not null,
...
alter table "public"."pfs" enable row level security;


  create table "public"."push-ids" (
    "id" text not null,
    "updated_at" timestamp with time zone not null default now(),
    "email" text not null,
    "luse_id" numeric not null
      );


alter table "public"."push-ids" enable row level security;
  ...
  create table "public"."settled_trades" (
    ...
    "sec_commision" double precision not null default '0.00125'::double precision,
    "luse_comission" double precision not null default '0.00375'::double precision,
...
CREATE UNIQUE INDEX "pf-reqs_pkey" ON public."pf-reqs" USING btree (id);

CREATE UNIQUE INDEX pfs_pkey ON public.pfs USING btree (id);

CREATE UNIQUE INDEX "push-ids_pkey" ON public."push-ids" USING btree (email);
...
alter table "public"."pf-reqs" add constraint "pf-reqs_pkey" PRIMARY KEY using index "pf-reqs_pkey";

alter table "public"."pfs" add constraint "pfs_pkey" PRIMARY KEY using index "pfs_pkey";

alter table "public"."push-ids" add constraint "push-ids_pkey" PRIMARY KEY using index "push-ids_pkey";
...
grant delete on table "public"."pf-reqs" to "anon";

grant insert on table "public"."pf-reqs" to "anon";

grant references on table "public"."pf-reqs" to "anon";

grant select on table "public"."pf-reqs" to "anon";

grant trigger on table "public"."pf-reqs" to "anon";

grant truncate on table "public"."pf-reqs" to "anon";

grant update on table "public"."pf-reqs" to "anon";

grant delete on table "public"."pf-reqs" to "authenticated";

grant insert on table "public"."pf-reqs" to "authenticated";

grant references on table "public"."pf-reqs" to "authenticated";

grant select on table "public"."pf-reqs" to "authenticated";

grant trigger on table "public"."pf-reqs" to "authenticated";

grant truncate on table "public"."pf-reqs" to "authenticated";

grant update on table "public"."pf-reqs" to "authenticated";

grant delete on table "public"."pf-reqs" to "service_role";

grant insert on table "public"."pf-reqs" to "service_role";

grant references on table "public"."pf-reqs" to "service_role";

grant select on table "public"."pf-reqs" to "service_role";

grant trigger on table "public"."pf-reqs" to "service_role";

grant truncate on table "public"."pf-reqs" to "service_role";

grant update on table "public"."pf-reqs" to "service_role";

grant delete on table "public"."pfs" to "anon";

grant insert on table "public"."pfs" to "anon";

grant references on table "public"."pfs" to "anon";

grant select on table "public"."pfs" to "anon";

grant trigger on table "public"."pfs" to "anon";

grant truncate on table "public"."pfs" to "anon";

grant update on table "public"."pfs" to "anon";

grant delete on table "public"."pfs" to "authenticated";

grant insert on table "public"."pfs" to "authenticated";

grant references on table "public"."pfs" to "authenticated";

grant select on table "public"."pfs" to "authenticated";

grant trigger on table "public"."pfs" to "authenticated";

grant truncate on table "public"."pfs" to "authenticated";

grant update on table "public"."pfs" to "authenticated";

grant delete on table "public"."pfs" to "service_role";

grant insert on table "public"."pfs" to "service_role";

grant references on table "public"."pfs" to "service_role";

grant select on table "public"."pfs" to "service_role";

grant trigger on table "public"."pfs" to "service_role";

grant truncate on table "public"."pfs" to "service_role";

grant update on table "public"."pfs" to "service_role";

grant delete on table "public"."push-ids" to "anon";

grant insert on table "public"."push-ids" to "anon";

grant references on table "public"."push-ids" to "anon";

grant select on table "public"."push-ids" to "anon";

grant trigger on table "public"."push-ids" to "anon";

grant truncate on table "public"."push-ids" to "anon";

grant update on table "public"."push-ids" to "anon";

grant delete on table "public"."push-ids" to "authenticated";

grant insert on table "public"."push-ids" to "authenticated";

grant references on table "public"."push-ids" to "authenticated";

grant select on table "public"."push-ids" to "authenticated";

grant trigger on table "public"."push-ids" to "authenticated";

grant truncate on table "public"."push-ids" to "authenticated";

grant update on table "public"."push-ids" to "authenticated";

grant delete on table "public"."push-ids" to "service_role";

grant insert on table "public"."push-ids" to "service_role";

grant references on table "public"."push-ids" to "service_role";

grant select on table "public"."push-ids" to "service_role";

grant trigger on table "public"."push-ids" to "service_role";

grant truncate on table "public"."push-ids" to "service_role";

grant update on table "public"."push-ids" to "service_role";
