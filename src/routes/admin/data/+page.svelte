<script lang="ts">
	...
	const fetchExpandedSymbol = async () => {
		try {
			const req = await fetch("/api/admin/data", {
				method: "POST",
...
<Head
	title="Market Data | SBZ Admin"
	ogTitle="Market Data"
	description="Take a look at neurally aided market data analysis."
	ogDescription="Take a look at neurally aided market data analysis."
/>
	...
	<div class="flex items-center">
		...
		<Tabs.Root bind:value={globalSummarySetting} class="ml-5">
			<Tabs.List>
				...
				<Tabs.Trigger class="ml-2 cursor-pointer" value="week">WoW</Tabs.Trigger>
			</Tabs.List>
		</Tabs.Root>
	</div>
</div>
...
<Summary>
		...
		{:else}
			...
			<div class="flex w-full flex-row">
				...
				{#if selectedSymbol !== "LASI"}
					<Button class="ml-5" variant="outline" onclick={openSheet}
	...
	{#snippet text()}
		{#if initStocks}
			<h3 class="loading no-padding w-fit">Lorem ipsum dolor sit amet amet</h3>
	...
	{#snippet main()}
		<div class="holder">
			{#if expandedLoading}
						...
						<tbody>
							<tr>
								...
								<td class="text-center"
									...
									></td
								>
								<td class="num text-center">{numParse(expandedSymbol.price.trail52H.toFixed(2))}</td
								>
								<td class="num text-center">{numParse(expandedSymbol.price.trail52L.toFixed(2))}</td
								>
							</tr>
						</tbody>
					</table>
				...
				<h2 class="loading no-padding mt-14 mb-5 w-fit">Profitability Metrics</h2>
				<div class="flex flex-row">
					<table class="loading no-padding table-fixed">
						<thead>
						...
						<tbody>
							<tr>
								<td class="num text-center"
									>{!expandedSymbol.profitability.cfps
										? "-"
										: numParse(expandedSymbol.profitability.cfps.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.profitability.eps
										? "-"
										: numParse(expandedSymbol.profitability.eps.toFixed(2))}</td
								>
							</tr>
						</tbody>
					</table>
					...
					<table class="loading no-padding ml-10 table-fixed">
						...
						<tbody>
							<tr>
								<td class="num text-center"
									>{!expandedSymbol.return.roe
										? "-"
										: percentageHandler(expandedSymbol.return.roe)}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.return.roa
										? "-"
										: percentageHandler(expandedSymbol.return.roa)}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.return.roi
										? "-"
										: percentageHandler(expandedSymbol.return.roi)}</td
								>
							</tr>
						</tbody>
					</table>
				...
				<div class="mt-10 flex flex-row">
					<table class="loading no-padding table-fixed">
						...
						<tbody>
							<tr>
								<td class="num text-center"
									>{!expandedSymbol.margins.gp
										? "-"
										: percentageHandler(expandedSymbol.margins.gp)}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.margins.pbit
										? "-"
										: percentageHandler(expandedSymbol.margins.pbit)}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.margins.pbt
										? "-"
										: percentageHandler(expandedSymbol.margins.pbt)}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.margins.np
										? "-"
										: percentageHandler(expandedSymbol.margins.np)}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.margins.tax
										? "-"
										: percentageHandler(expandedSymbol.margins.tax)}</td
								>
							</tr>
						</tbody>
					</table>
				...
				<div class="flex flex-row">
					...
					<table class="summary-table table-fixed">
						...
						<tbody>
							<tr>
								<td class="num text-center"
									>{!expandedSymbol.liquidity.current
										? "-"
										: numParse(expandedSymbol.liquidity.current.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.liquidity.quick
										? "-"
										: numParse(expandedSymbol.liquidity.quick.toFixed(2))}</td
								>
							</tr>
						</tbody>
					</table>
					...
					<table class="summary-table table-fixed">
						<thead>
							<tr>
								...
								<th>Average Collection Period</th>
								<th>Average Payment Period</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="num text-center"
									>{!expandedSymbol.efficiency.assTurn
										? "-"
										: numParse(expandedSymbol.efficiency.assTurn.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.efficiency.acp
										? "-"
										: numParse(expandedSymbol.efficiency.acp.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.efficiency.app
										? "-"
										: numParse(expandedSymbol.efficiency.app.toFixed(2))}</td
								>
							</tr>
						</tbody>
					</table>
				...
				<div class="flex flex-row">
					...
					<table class="summary-table table-fixed">
						...
						<tbody>
							<tr>
								<td class="num text-center"
									>{!expandedSymbol.intrinsic.nav
										? "-"
										: numParse(expandedSymbol.intrinsic.nav.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.intrinsic.pe
										? "-"
										: numParse(expandedSymbol.intrinsic.pe.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.intrinsic.pb
										? "-"
										: numParse(expandedSymbol.intrinsic.pb.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.intrinsic.entVal
										? "-"
										: numParse(expandedSymbol.intrinsic.entVal.toFixed(2))}</td
								>
							</tr>
						</tbody>
					</table>
					...
					<table class="summary-table ml-10 table-fixed">
						...
						<tbody>
							<tr>
								<td class="num text-center"
									>{!expandedSymbol.div.net ? "-" : numParse(expandedSymbol.div.net.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.div.yield
										? "-"
										: percentageHandler(expandedSymbol.div.yield)}</td
								>
							</tr>
						</tbody>
					</table>
				...
				<div class="flex flex-row">
					...
					<table class="summary-table table-fixed">
						...
						<tbody>
							<tr>
								<td class="num text-center"
									>{!expandedSymbol.capm.beta
										? "-"
										: numParse(expandedSymbol.capm.beta.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.capm.er ? "-" : percentageHandler(expandedSymbol.capm.er)}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.capm.fv ? "-" : numParse(expandedSymbol.capm.fv.toFixed(2))}</td
								>
								<td class="num text-center"
									>{!expandedSymbol.capm.alpha
										? "-"
										: percentageHandler(expandedSymbol.capm.alpha)}</td
								>
							</tr>
						</tbody>
					</table>
